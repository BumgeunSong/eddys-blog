---
title: 불확실성에 대처하는 스타트업의 전략
published_date: 2017-05-05 00:00
tags: 전략, 스타트업, 경영
meta_description: 린 스타트업 Lean Startup
meta_image: https://img1.daumcdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/15UX/image/UXaVFeT750PwkWYEkNb1DYD4hLE.jpg
lang: ko
---

# 불확실성에 대처하는 스타트업의 전략

# 스타트업계의 고전, Lean startup
...
그러나 스타트업의 상황은 완전히 다르다. 스타트업은 새로운 시장을 창조해야 한다. 기존의 시장에서는 적은 자원으로 대기업들과 경쟁하기 매우 어렵다. 모두 <a href="http://www.bloter.net/archives/221159" class="link" target="_blank"></a>
...
그러나 겸손한 마음으로 고객이 무엇을 원하는지 아는데 집중한다면, 고객의 행동과 심리, 맥락들을 하나하나 이해해가는 것이 성과다. 최소한의 비용과 시간으로 **고객에 대해서 배우는 것**이 성과가 된다.

고객 가치가 무엇인지에 대한 학습(Validated learning), 이것이 Lean startup의 지향점이다.

# 군살 빼기

Lean은 ‘군더더기 없는’이란 뜻이 있다. Lean startup의 원조 격인 Lean production은 도요타 자동차가 각 생산 프로세스에서 **낭비를 모두 제거**하는 데 집중했기 때문에 그런 이름이 붙여졌다. 이와 마찬가지로 Lean startup도 서비스 개발에서 비효율을 최소화하려는 방법론이다.
...
고객, 시장이 원하는 것을 캐치하느냐 못하느냐가 스타트업에게는 무엇보다 중요하다. 매출액, 사용자 수, 직원 수, 투자 유치 금액 등등은 성공의 본질이 아니다. 궁극적으로 **고객이 원하는 것을 파악해 가치를 제공**해야 지속 가능한 비즈니스를 만들 수 있다. Lean startup은 이 원칙에 입각해 핵심에 집중함으로써 군더더기를 모두 빼고 속도와 효율성을 얻는다.

# **Build-Measure-Learn**

따라서 Lean startup을 구성하는 여러 방법론은 모두 **최소한의 노력으로 최대한의 배움을 얻는 수단**이다.
...
![leanstartup-cycle.jpg](/Users/bumgeunsong/coding/writing-archiver/archiver/brunch_md/bumgeunsong-14/assets/739588915150a0315600f763b478cc66114a3d3d.jpg)
...
리더의 의사결정을 연구한 정재승 교수에 따르면, 뛰어난 리더는 모두 100% 확신에 집착하지 않는다는 공통점이 있다고 한다. 이들은 70%-80%의 확신이 들면 결정을 내리고 대신 그 결정을 유연하게 바꾼다. <a href="http://sciencebooks.minumsa.com/book/631/" class="link" target="_blank"></a>
...
![](/Users/bumgeunsong/coding/writing-archiver/archiver/brunch_md/bumgeunsong-14/assets/8098daee649683d73fc016c257adc81b5ee73b92.jpg)
...
![](/Users/bumgeunsong/coding/writing-archiver/archiver/brunch_md/bumgeunsong-14/assets/76dc5f844f53f2bed469ee6d46c65580f8f110c2.jpg)

Lean startup은 **자동차 운전**과 같다. 가는 목적지가 정확하지 않고, 주변 상황이 빠르게 바뀌기 때문이다. 자동차를 운전할 때 우리는 무의식적으로 끊임없이 주변 환경, 도로 상황, 신호등을 보면서 끊임없이 미세 조정을 한다.
