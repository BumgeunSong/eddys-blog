...
published_date: 2021-08-09 00:00
tags: 학습, 시험, 자기계발
meta_description: 인풋이 아닌, 아웃풋 중심으로 노력하기
meta_image: https://img1.daumcdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/15UX/image/kNVhpcESyA-9exvHXXP1yWB2gj4.png
lang: ko
---

# 가장 빠르게 스킬과 지식을 쌓는 방법

**요약**

1. 스킬: 준비보다 실전 먼저

프로젝트 기반 학습 / 시뮬레이션 만들기 / 자발적 책임 만들기

2. 지식: 공부보다 시험 먼저

플래시 카드와 SRS / 자유 회상 / 질문 생각하고 읽기

3. 관점: 생각보다 표현 먼저

콘텐츠 요약, 리뷰 쓰기 / 다른 사람에게 설명하기 / 프리라이팅
...
> 빠르게 무언가 익히고 싶다면. 인풋이 아닌 아웃풋에 초점을 맞춰야 한다고 생각해요. 그게 스킬을 습득하는 것이든, 지식을 쌓는 것이든, 나만의 관점을 만드는 것이든 말이죠.

> 경험상 항상 아웃풋 중심의 노력을 해야 가장 효과가 좋더라고요.
...
나는 인풋에 무척이나 집착한다. 성장하고 싶은 욕구가 강해서일까.

본능적으로 더 많이 읽고 보고 들으려고 한다.

좋은 노하우, 좋은 지식, 좋은 인사이트, 좋은 사례를 계속 찾는다.

특히 서점에 가서 책 쇼핑하는 걸 사랑하고, 별 일이 없을 때도 코세라나 유데미에 가서 강좌를 둘러보는 걸 좋아한다. 좋은 지식콘텐츠가 있다면 무조건 찾아가서 구독한다. 뭔가를 배우고 싶은 열망 때문이다.

하지만 시행착오를 통해 어렴풋하게 깨달았다. 진짜 빨리 배우고 싶다면 질문을 바꿔야 한다.

사람들은 성장하고 싶은 욕구가 있을 때 본능적으로 ‘인풋’을 늘리려는 경향이 있다.

![](/Users/bumgeunsong/coding/writing-archiver/archiver/brunch_md/bumgeunsong-148/assets/2b3fb258c2eabb81ffc3b85548742ae951eb517e.jpg)

좋은 인풋을 많이 넣으면 아웃풋이 나온다는 생각이다.

누군가는 이렇게 생각할 것이다.

> 당연하지, 인풋이 있어야 아웃풋이 나오는 거 아니야?
>
...
직접 하면서 배워야 빠르다. 아는 걸 말로 설명해봐야 더 오래간다… 대부분 알고는 있다. 그러나 잘 실천하지 않는다. 왜냐하면 아웃풋 기반의 노력은 상대적으로 불편하고 두렵기 때문이다.
...
> 제가 IT업계 취직을 생각하고 있어요. 근데 관련 지식이 없어서…
> 업계 지식을 쌓기에 좋은 책이나 채널이 있을까요?

여기서 질문한 사람은 인풋 중심 노력을 생각했다.

IT업계 소식을 알려주는 좋은 책이나 뉴스레터를 찾아 읽는 것.

하지만 나는 그것보다 아웃풋 중심 노력을 추천한다.

매일 IT업계 뉴스를 본인이 정리해서 올리는 SNS계정을 만드는 것.

아웃풋을 내는 것을 강제 목표로 잡는다. 그러면 인풋은 자연스럽게 될 수 밖에 없다. 하지만 그냥 읽는 것과, 아웃풋을 준비하기 위해 책과 뉴스를 읽는 것은 효율이 완전히 다르다.
...
아웃풋이라는 말이 상당히 추상적일 수 있다.

그래서 구체화해봤다. ‘아웃풋 중심’을 스킬/지식/관점으로 나눴다.

![](/Users/bumgeunsong/coding/writing-archiver/archiver/brunch_md/bumgeunsong-148/assets/5b377a66beb1269cde33537884d213f0d5788245.png)

준비, 읽기, 생각은 인풋의 관점이고, 실전, 시험, 표현은 아웃풋의 관점이다.

우리는 배울 때 왼쪽의 단어들을 더 선호하지만, 의도적으로 오른쪽 단어에 집중할 수록 더 얻는 게 많다.
...
![](/Users/bumgeunsong/coding/writing-archiver/archiver/brunch_md/bumgeunsong-148/assets/d91c40f70ad455dd0997d2e9d647e4394a919480.jpg)
...
이때 프로젝트는 <a href="http://egloos.zum.com/agile/v/2807583" class="link" target="_blank"></a>

**시뮬레이션 만들기.**

어떤 경우엔 진짜 실전처럼 해보는 게 매우 어려울 수 있다. 그럴 때는 특정 부분만 떼내 비슷한 상황을 만들어 연습을 할 수도 있다.

나의 예를 들어보자면, 나는 조회수가 잘 나오는 기사를 예측하고 싶었다. 하지만 매번 새로운 기사를 써서 예측 연습을 하기에는 시간이 너무 오래 걸렸다. 그래서 과거 데이터를 가지고, 시뮬레이션을 만들었다. 제목과 썸네일을 보고 <a href="https://www.learningman.co/practicereview/" class="link" target="_blank"></a>
...
<a href="https://brunch.co.kr/@bumgeunsong/105" class="link" target="_blank"></a>
...
**<u>하지만 실제 결과는, 자유 회상이 가장 높았다.</u>**

다른 그룹보다 50% 이상 많은 것을 장기 기억했다.
...
![](/Users/bumgeunsong/coding/writing-archiver/archiver/brunch_md/bumgeunsong-148/assets/35817d9ae413426583cb1b57ac2cc52c6f93492b.png)

사전에 시험을 치면 기억 속에서 알고 있는 내용을 떠올리려고 노력(Retrieval)을 한다. 이 행동이 학습효과를 올려준다. (이외에도 시험 효과를 뒷받침하는 연구가 매우 많다. 학계에서는 정설로 받아들여진다. 자세한 내용은 <a href="https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=49588358" class="link" target="_blank"></a>을 참고)
...
**플래시 카드와 SRS (Spaced Reptition Software)**

플래시 카드란 우리가 흔히 아는 낱말 카드를 말한다. 앞면에 ‘Apple’, 뒷면에 ‘사과’라고 쓰여 있는 식이다. 배운 것을 복습하기 위한 용도로 많이 쓰인다.

특히 적절한 간격으로 계속 플래시 카드 복습을 반복해서 떠올리면 장기기억에 매우 효과적이다. 이런 방법을 ‘액티브 리콜’이라고 한다. 액티브 리콜을 도와주는 앱이 SRS. 의대생, 법대생 등 공부량이 많은 대학생 사이에서는 유명한 방법. (<a href="https://brunch.co.kr/@jade/106" class="link" target="_blank"></a>)

**자유 회상**

<a href="https://www.learningman.co/algorithmstudychallenge/" class="link" target="_blank"></a>이라고도 한다. 책을 읽거나 강의를 듣는다. 그다음 그걸 보지 않고 빈 종이에 기억나는 것을 모조리 적는다. 해보면 생각보다 괴롭다. 이렇게나 기억이 나는 게 없다니?
...
![](/Users/bumgeunsong/coding/writing-archiver/archiver/brunch_md/bumgeunsong-148/assets/913aad3569b2446fda8a7c71b04b22f813e3b712.jpg)
...
<a href="https://www.learningman.co/output/?fbclid=IwAR1SswsUsOxQg3WKDL_9yHi1ysfnEi-97PHhxCg6OvvX2wSyadBAdjzcpV8" class="link" target="_blank"></a> 머릿속이 잘 정리가 되어있지 않다하더리도 이해하고 있는 지식, 관련 생각들을 쏟아놓다 보면 또 다른 관점과 표현으로 연결이 된다. 여기서 핵심은, 쓰면서 내용을 판단하지 않는 것.
