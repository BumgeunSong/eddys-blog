---
title: 매글프 개발 일지 시리즈
published_date: 2025-09-01 00:00
lang: ko
---
...
1. 댓글 잔디: 눈으로 볼 수 있게 되면 댓글 잔디도 심고 싶은 마음이 들겠지?

2. 유저 프로필 페이지: 게시판이 약 500-600회. 알림이 120회. 그리고 사용자 페이지는 36회다. 역시나 참 제품이란 건, 내 예상과는 전혀 다르구나. 아이디어는 언제나 쌓였지만. 실제로 가치를 주는 것은 정말 적다.

3. 매글프 모집 페이지: 활동중인 멤버들의 목록 리스트를 볼 수 있도록 개선

4. 다음 기수 신청하기: 피드백과 NPS 부분은 사실 오늘 글을 쓰기 전까지 거의 관심을 놓치고 있던 부분

<h2><strong><a href="https://dailywritingfriends.com/board/ImpCznXpaAskJEXYt8kh/post/8jlst4kaEwtj69vlsRuj" rel="noopener noreferrer" target="_blank">6.4 매글프 개발 일지</a></strong></h2>- Daily Posting (7D Avg): 14.4개 (-0.3)

- Daily Comment (7d Avg): 72개 (-8)

- 연속 7일 이상 달성 유저 비율: 15.3% (+4.6%) (혜봄님 감사 🙏)

비밀 친구 기능 업데이트: '내 글을 보고 다른 사람은 나를 어떻게 생각할까?

유저 정보 캐싱 전략 개선: 이제 사용자 정보 빠르고 정확하다.

이모지 기능 개선: 자주 쓰는 이모지 열몇개로 확 줄이고, 검색 없이 클릭으로 바로 입력할 수 있게 바꾸었습니다

글감 카드 기능 오픈: 카드 보여주고, 누르면 글쓰기 에디터에 질문을 프리필<h2>
</h2><h2><strong><a href="https://dailywritingfriends.com/board/ImpCznXpaAskJEXYt8kh/post/GhpIBHhEPIthPoRKbglQ" rel="noopener noreferrer" target="_blank">매글프 개발 일지를 스레드에 올릴 것이다</a></strong></h2>작성일: 25. 06. 19.

뭔가 잘 맺고 싶고. 공개적으로 남겨두고 싶었다. 나중에 뒤돌아봤을 때 뿌듯하도록. 어딘가 퍼블릭하게 써보면 좋겠다는 생각이 들었다.

<h2><strong><a href="https://dailywritingfriends.com/board/goCsk2UgAGigmpaxFWTi/post/x5Cyertxkp1w75eG7o5h" rel="noopener noreferrer" target="_blank">매글프 개발 일지: 원고 청탁 아이디어</a></strong></h2>매글프에서 원고료 개념을 만들면 어떨까?

매 기수마다 매글프 사람들은 일정 금액을 충전한다.

다른 사람의 글을 보다가, 이 글이 너무 좋았다면 '이 시리즈 더 주세요' 라는 메시지와 함께 '원고료'를 걸 수 있다.

이제 글쓴이는 원고료 퀘스트를 받는다. 글을 잘 써서 누군가에게 공감을 일으킨 죄로 원고료 퀘스트를 받는다. 상대방이 요청한 글을 일정 시간 내에 써주면, 상대방이 걸어둔 원고료를 받을 수 있다. (내키지 않는다면 안쓰는 것도 본인의 선택일 것이다)
...
<h2><strong><a href="https://dailywritingfriends.com/board/usjFgSCEQdO4oE2Lo3EZ/post/wMS2kxBF7CDRF3soaU1j" rel="noopener noreferrer" target="_blank">25.07.22 매글프 개발일지</a></strong></h2>Daily Posting (7D Avg): 14.4개 (6주 전 동일)

Daily Comment (7d Avg): 56개 (6주 전보다 -16)

연속 7일 이상 달성 유저 비율 24% (6주 전보다 +8.7%)

연속 일수 복구 아이디어는 듀오링고 같은 앱에서 영감을 받았다. 연속이 깨지면 의욕도 깨진다. 하지만 꺼진 불씨를 다시 살릴 수 있다면 훨씬 더 전체적인 열정량을 늘릴 수 있다. 아직 버그가 있을 수도 있고, 지표 변화를 관찰하기엔 이르기 때문에. 실제로 이 복구 기능이 효과가 있었는지는 다음 개발 일지에 써야겠다.

<h2>25.09.01</h2>Daily Posting (7D Avg): 13.6개 (-0.8)

Daily Comment (7d Avg): 53개 (-3)

연속 7일 이상 달성 유저 비율: 20% (-4%)
