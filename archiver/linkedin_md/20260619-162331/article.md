...
meta_description: 같은 모델, 같은 클로드 코드였다. 그런데 한쪽은 믿을 수가 없었다. 한쪽은 깔끔해서 고칠 게 없었다. 무슨 차이였을까? AI한테 E2E 테스트를 짜라고 시켰다. 멀쩡한 코드에 자꾸 실패가 떴다. 버그도 심어봤다. 통과했다. AI가 짠 테스트는 도무지 믿을 수가...
lang: ko
---
