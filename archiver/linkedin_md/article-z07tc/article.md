...
meta_description: '아 저 컴포넌트에다 저런 조회 로직 추가하면 안되는데...'
...
이런 문제가 있으면 흔히 <a href="http://AGENTS.md" target="_blank">AGENTS.md</a> / <a href="http://CLAUD.md" target="_blank">CLAUDE.md</a> 를 잘 쓰라고 합니다. DON'T. 이렇게 하지마. DO. 이렇게 해. 크게 대문자로 쓰라고요.
...
더 구체적인 예시가 필요한 분들을 위해 예시 레포를 하나 만들어두었습니다. <a href="https://github.com/BumgeunSong/lint-enforced-architecture" target="_blank"><strong>lint-enforced-architecture &gt;&gt;</strong></a>
...
더 구체적인 예시가 필요하신 분들을 위해, Typescript 기준 레포지토리를 간단하게 만들어두었으니 보셔도 좋습니다. <a href="https://github.com/BumgeunSong/lint-enforced-architecture" target="_blank"><strong>lint-enforced-architecture &gt;&gt;</strong></a>
