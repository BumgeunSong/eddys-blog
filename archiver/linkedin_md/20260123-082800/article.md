...
meta_description: AI한테 일 시키다가 중간에 이상해졌다면? - 서브 일꾼(subAgent) 활용법 3가지 subAgent가 핫하다. 어려워보이지만 사실 별거 아니다. 그냥 일꾼 하나 더 소환하는 거다. 클로드 코드를 켜면 대답하는 녀석. 얘가 메인 일꾼이다. 그런데 메인 일꾼이,...
lang: ko
---
