---
title: 해? 말아? 단위 테스트의 가성비를 판단하는 법
published_date: 2022-06-02 12:56
tags: iOS, unit test
meta_description: 단위 테스트는 중요하다. 구구절절 옳다. 하지만... 
meta_image: https://velog.velcdn.com/images/eddy_song/post/a4c8a497-a4f4-4823-8531-123a7f6d4a49/image.png
lang: ko
---
...
['선택적 단위 테스트'](http://blog.stevensanderson.com/2009/11/04/selective-unit-testing-costs-and-benefits/)라는 아티클이 하나 있다. 스티브 샌더슨(Steve Sanderson)이 2009년에 쓴 글이다. 내가 본 단위 테스트 글 중에서 가장 도움이 많이 됐다.

이 글은 테스트의 '가성비'를 가늠하는 간단한 기준을 제시한다.

테스트의 가성비는 2가지만 보면 대충 각이 나온다. 그 2가지는, 코드의 **'예측가능성'**과 **'외부 의존성'**이다.
...
![](/Users/bumgeunsong/coding/writing-archiver/archiver/velog_md/eddy_song-cost-benefit-unit-test/assets/ca32ac63a5e427ed54b013bc7df2df768398cedc.png)
