  ...
  return (
    <article>
      <nav className="mb-4">
        <Link
          href="/"
          className="inline-block text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 motion-safe:active:-translate-x-0.5 transition-[color,transform] duration-150 ease-out"
        >
          ← 목록
        </Link>
      </nav>
